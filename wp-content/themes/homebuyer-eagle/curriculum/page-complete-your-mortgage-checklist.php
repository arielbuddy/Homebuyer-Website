...
<div class="container md:pt-30 md:pb-24">
  ...
  <div class="flex flex-col md:flex-row gap-11 mb-20 md:mb-30">
    ...
    <div class="flex-1">
      ...
      <div class="post">
        <p>When you’re buying a home, there are a lot of moving parts. And it can be easy to forget about a document here or there. This is why most lenders provide you with a clear mortgage checklist that will serve as a simple roadmap guiding you through getting your mortgage loan.</p>
