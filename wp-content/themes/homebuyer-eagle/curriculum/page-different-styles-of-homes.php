...
<div class="container md:pt-30 md:pb-24">
  ...
  <div class="flex flex-col md:flex-row gap-11 mb-20 md:mb-30">
    ...
    <div class="flex-1">
      <h3 class="mb-8">Different Styles of Homes</h3>
      <div class="w-full mb-12 md:w-auto md:h-110 rounded-2xl overflow-hidden aspect-video">
        <iframe class="h-full w-full" src="https://www.youtube.com/embed/txbP4sAV8RI" frameborder="0"></iframe>
      </div>
      <div class="post">
        <p><a href="<?php echo home_url(); ?>/wp-content/uploads/2022/03/Different-Styles-of-Homes.png">Infographic - Most Popular Home Styles</a></p>
      </div>
    </div>
  </div>
</div>
