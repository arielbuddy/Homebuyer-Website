<?php
/*
Template Name: Mortgage Loan Limits
*/
...
if ($countyName) {
    if (file_exists(dirname(__FILE__) . "/mortgage-loan-limits/$countyName.php")) {
        include("mortgage-loan-limits/$countyName.php");
        exit;
    }
    global $wp_query;
    $wp_query->set_404();
...
$data = [
    ...
    'nearby' => [
        ...
        'kings-county-new-york' => 'Kings County, New York',
    ...
    'ethnicity' => [
        'Hispanic or Latino' => 2.75,
        'Not Hispanic or Latino' => 96.03,
        'Joint' => 1.21
    ]
];
...
$title = "$year U.S. Mortgage Loan Limits";
$description = "$year U.S. Loan Limits: $" . number_format($data['oneUnitConforming'][$year]) . " (Conforming), $" . number_format($data['oneUnitFha'][$year]) . " (FHA).";
...
add_action( 'wp_head', function () {
    ...
    echo '<meta property="og:updated_time" content="2023-07-25T18:18:21.3160-4:00" />' . "\n";
    ...
    echo '<meta property="article:modified_time" content="2023-07-25T18:18:21.3160-4:00" />' . "\n";
    ...
    echo '<meta name="twitter:data2" content="3 minutes" />' . "\n";
}, 1);
...
<div class="hub hub-header">
    <div class="hub-container">
        <ul class="hub-breadcrumb">
            ...
            <li> <strong>Mortgage Loan Limits</strong> </li>
        </ul>
        ...
        <h1><?php echo $year; ?> U.S. Mortgage Loan Limits</h1>
        <div class="hub-header-author">
            <?php
                ...
                echo '<img src="https://homebuyer.com/wp-content/uploads/2023/01/Dan_Green_-_Headshot_-_2022-150x150.jpg" alt="Dan Green" />';
            ?>
            <div>
                <div>Author: <?php /* the_author_posts_link(); */ echo '<a href="https://homebuyer.com/author/dan-green">Dan Green</a>'; ?></div>
...
<div class="hub hub-main">
    <div class="hub-container">
        ...
        <div class="ll-map-container">
            <h4>U.S. mortgage loan limits apply in:</h4>
            <div id="ll-map"></div>
        </div>
        <script>
            let map;
        ...
        <p>Mortgage loan limits are the upper boundaries for how much a home buyer can borrow on a mortgage. Loan limits vary by county and home type.</p>
        ...
        <div class="hub-table">
            <div class="hub-table-header">
                <h3><?php echo "National Mortgage Data (2018-2022)"; ?></h3>
            </div>
        ...
        <a class="hub-cta-box" href="https://homebuyer.com/learn/hmda-mortgage-statistics">
            <div>
        ...
        <div class="ll-cta">
            <a class="hb-button" href="https://app.homebuyer.com">
                Get Pre-approved
            </a>
        </div>
    </div>
