...
$data = [
    'county' => 'Yukon-Koyukuk Census Area, Alaska',
    'createdAt' => '2023-07-28T04:02:30.2530-4:00',
    'oneUnitConforming' => [
        '1970' => 33000,
        '1971' => 33000,
        '1972' => 33000,
    ...
    'nearby' => [
        'bethel-census-areaalaska' => 'Bethel Census Area, Alaska',
        'denali-boroughalaska' => 'Denali Borough, Alaska',
        'fairbanks-north-star-boroughalaska' => 'Fairbanks North Star Borough, Alaska',
        'matanuska-susitna-boroughalaska' => 'Matanuska	Susitna Borough, Alaska',
        'nome-census-areaalaska' => 'Nome Census Area, Alaska',
        'north-slope-boroughalaska' => 'North Slope Borough, Alaska',
        'northwest-arctic-boroughalaska' => 'Northwest Arctic Borough, Alaska',
        'southeast-fairbanks-census-areaalaska' => 'Southeast Fairbanks Census Area, Alaska',
        'kusilvak-census-areaalaska' => 'Kusilvak Census Area, Alaska',
        'yukon-koyukuk-census-areaalaska' => 'Yukon	Koyukuk Census Area, Alaska'
    ],
    'cities' => [
        'Alatna',
        'Allakaket',
    ...
    'race' => [
        'American Indian or Alaska Native' => 46.15,
        'Asian' => 2.56,
...
add_action( 'wp_enqueue_scripts', function () {
    wp_enqueue_style( 'content-hub', get_template_directory_uri() . '/css/hub/hub.css', array('style'), rand(111,9999), 'all' );
    wp_enqueue_style( 'loan-limits', get_template_directory_uri() . '/css/hub/loan-limits.css', array('style'), rand(111,9999), 'all' );
    wp_enqueue_script( 'hub', get_template_directory_uri() . '/js/hub.js', array(), rand(111,9999), true );
});
            ...
            <script>
                ...
                async function initSearch() {
                    ...
                    document.getElementById("county-lookup-button").addEventListener('click', () => {
                        window.location = '<?php echo home_url(); ?>/mortgage-loan-limits/' + target;
                    });
                }
                initSearch();
            </script>
